...
* [`aiida_ssh2win/`](aiida_ssh2win/): The main source code of the plugin package
  * [`data/`](aiida_ssh2win/data/): A new `DiffParameters` data class, used as input to the `DiffCalculation` `CalcJob` class
  * [`calculations.py`](aiida_ssh2win/calculations.py): A new `DiffCalculation` `CalcJob` class
  * [`cli.py`](aiida_ssh2win/cli.py): Extensions of the `verdi data` command line interface for the `DiffParameters` class
  * [`helpers.py`](aiida_ssh2win/helpers.py): Helpers for setting up an AiiDA code for `diff` automatically
  * [`parsers.py`](aiida_ssh2win/parsers.py): A new `Parser` for the `DiffCalculation`
...
```shell
verdi data ssh2win list
verdi data ssh2win export <PK>
```
...
See the [developer guide](http://aiida-ssh2win.readthedocs.io/en/latest/developer_guide/index.html) for more information.
